 ...
 * @author xmw13bzu
 */
@WebServlet(name = "PhysicalHealthLogController", urlPatterns = {"/PhysicalHealthLogController"})
public class PhysicalHealthLogController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session == null) 
            throw new ServletException("Attempting to access weight logs page while no session is active (no user logged in)");
